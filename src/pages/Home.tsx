    ...
    <>
      <div className="home section-padding pt-[80px] relative">
       ...
       max-lg:items-start mt-[80px] max-lg:gap-[20px] mb-[150px] max-sm:mb-[100px]"
        ...
        max-sm:flex-col max-sm:h-[120px] max-sm:pb-[10px] max-sm:p-[10px]"
          >
            <form
              className="flex flex-2 items-center max-sm:justify-start max-sm:w-full
            max-sm:flex-col"
            >
      ...
      max-sm:mt-[100px]"
          ...
          <div className="mt-[80px] relative switch-testi">
            ...
            max-lg:px-[0] switch-testi opacity-0 ${
              ...
              >
                ...
                max-sm:text-[1.5em]"
                  >
                    “There are lot of interesting projects that casting
                    directors post on this platform. So many people and
                    companies trust casting through Platform”
                  </h2>
                  <p>
        ...
        <div className="mt-[200px] mb-[200px]">
          <div
            className="w-[70px] h-[70px] border-solid border-[var(--grey-color)] border-[2px]
        p-[15px] mx-auto mb-[50px]"
          >
            <img src="https://cdn.prod.website-files.com/63337525695d8ba70ab44222/63460dd2fa932e74fbd2222d_Magnifying%20Glass%20Icon.png" />
          </div>
          <h2 className="text-[30px] font-bold text-center mb-[20px]">
            Explore a job now!
          </h2>
          <p
            className="text-[var(--text-grey-color)] text-center w-[500px] mx-auto
          max-md:w-fit"
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
            rhoncus pharetra cursus. Suspendisse sodales porta leo, ac placerat
            ex pretium quis.
          </p>
          <div
