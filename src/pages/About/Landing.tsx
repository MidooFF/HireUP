...
const Landing = () => {
  return (
    ...
    relative mb-[300px] max-lg:pb-[300px] max-sm:pb-[150px] max-sm:mb-[150px]"
    >
      <p
      ...
      <div
        className="flex justify-between items-end py-[25px] pb-[30px]
      max-lg:flex-col max-lg:items-start max-lg:pb-[40px]"
      >
        <h2
          className="text-[40px] leading-[1.2] text-white font-bold
        popup popup-1 max-sm:text-[30px]"
        >
          Hireup is a webflow membership template.
        </h2>
        <h3 className="text-white popup popup-2 max-lg:mt-[20px]">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
          rhoncus pharetra cursus. Suspendisse sodales porta.
        </h3>
      </div>
      <div
        className="absolute w-full left-0 h-[600px] max-sm:h-[300px]
